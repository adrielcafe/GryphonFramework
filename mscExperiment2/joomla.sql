...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2015 at 06:21 AM
...
(18, 1, 65, 96, 1, 'com_modules', 'com_modules', '{"core.admin":{"7":1},"core.manage":[],"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
...
(39, 18, 66, 67, 2, 'com_modules.module.1', 'Main Menu', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
...
(51, 18, 90, 91, 2, 'com_modules.module.17', 'Breadcrumbs', '{"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
...
(54, 8, 20, 27, 2, 'com_content.category.8', 'Tech', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(55, 8, 28, 35, 2, 'com_content.category.9', 'Science', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(56, 8, 36, 45, 2, 'com_content.category.10', 'Design', '{"core.create":{"6":1,"3":1},"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1},"core.edit.own":{"6":1,"3":1}}'),
(57, 54, 21, 22, 3, 'com_content.article.1', 'Windows 10 is the end of cloud-free computing', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(58, 56, 37, 38, 3, 'com_content.article.2', 'Art installation brings drone killings to life', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(59, 54, 23, 24, 3, 'com_content.article.3', 'Google delays its Project Ara modular smartphone until 2016', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(60, 56, 39, 40, 3, 'com_content.article.4', 'The BMW Concept M4 GTS is an M4 on steroids — and you''ll be able to buy it', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(61, 54, 25, 26, 3, 'com_content.article.5', 'How to buy an iPhone in America', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(62, 55, 29, 30, 3, 'com_content.article.6', 'US gives Shell the final approval it needs to drill for oil in the Arctic', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(63, 55, 31, 32, 3, 'com_content.article.7', 'Google Maps can now tell you if it’s worth installing solar panels on your roof', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(64, 55, 33, 34, 3, 'com_content.article.8', 'Watch as astronauts soar over an Aurora Borealis in the space station', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(65, 56, 41, 42, 3, 'com_content.article.9', 'Samsung gives its premium headphones what they really need: a gold color option', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(66, 56, 43, 44, 3, 'com_content.article.10', 'BMW fixed the 3.0 CSL Hommage concept car, and now it looks amazing', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}');
...
(8, 54, 1, 11, 12, 1, 'tech', 'com_content', 'Tech', 'tech', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":"","image_alt":""}', '', '', '{"author":"","robots":""}', 753, '2015-08-17 21:15:05', 753, '2015-08-17 21:15:24', 0, '*', 1),
(9, 55, 1, 13, 14, 1, 'science', 'com_content', 'Science', 'science', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":"","image_alt":""}', '', '', '{"author":"","robots":""}', 753, '2015-08-17 21:15:29', 0, '2015-08-17 21:15:29', 0, '*', 1),
(10, 56, 1, 15, 16, 1, 'design', 'com_content', 'Design', 'design', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":"","image_alt":""}', '', '', '{"author":"","robots":""}', 753, '2015-08-17 21:16:23', 0, '2015-08-17 21:16:23', 0, '*', 1);
...
(1, 57, 'Windows 10 is the end of cloud-free computing', 'windows-10-is-the-end-of-cloud-free-computing', '<p>In the weeks after its release, Windows 10 users have noticed something strange — it''s always phoning home. Last week, an Ars Technica investigation found Windows computers sending data back to Microsoft servers even after services like Cortana and OneDrive had been disabled, in one case even sending back a message as soon as users hit the Start button.</p>\r\n<p>It''s a telling change for Microsoft — the last major tech company built on self-contained software — and it’s set off a string of related worries. If any Microsoft users had been scared off by data collection from Google and Apple, they now have nowhere to turn. Reached by Ars Technica, the company was quick to defend itself, saying, "No query or search usage data is sent to Microsoft, in accordance with the customer''s chosen privacy settings." Most of the data is anonymized usage logging, not inherently a privacy concern, but the fact remains: using Windows 10 requires constant access to Microsoft''s remote servers, and that access goes both ways.</p>\r\n<p>In 2015, this is simply how computing works. Consumers expect smart recommendations and continually improving services. We expect computers — all computers — to be able to answer any question at any time. In return, companies get constant access to your computer for data collection, automatic updates, and offboard processing. This isn''t an option anymore; it''s the default. And anyone who doesn''t like the deal is going to have a very hard time using today''s computers.</p>\r\n<p>Mobile tech works this way out of necessity — there simply isn''t the processing power to take on more complex tasks — and over the last five years, even more powerful computers have followed that model. It''s essentially the premise of all Google''s software efforts. Most Chromebooks are constantly feeding data back to Google servers, even though it happens more often through Drive or Search services than the OS itself. If the services are going to improve, engineers need to know what''s working and what isn''t — and since the services themselves are all free, some level of data-targeted advertising is inevitable. Companies go back and forth on how much to collect and how much to anonymize, but the overall choices have turned out very much the same. Apple ran into its own version of this problem when Yosemite launched last year: the revamped Spotlight Search function fed queries back to Apple Headquarters. But if Spotlight is going to handle web-facing queries like "restaurants near me," what else could it do?</p>\r\n<p>For a long time, Microsoft was the exception to this rule. The company has rolled out lots of cloud services, but they''ve been discrete offerings, rarely baked into the OS itself, in part because the new approach cut against Microsoft''s traditional strengths. That logic changed with Windows 10 because it had to. If Microsoft is going to steal users back from Apple and Google, it needs to match services like Siri and Google Voice, which means plugging into the cloud at the deepest possible level.</p>\r\n<p>But while software has changed, the world has been changing around it. Corporate clouds aren''t as secure as they once were, and we''ve seen them compromised by government spies and Redditors alike. Last year, Microsoft chased down an in-house leaker by peeking into a private blogger''s Hotmail account, offering profuse apologies after the fact. But for anyone who wants to exercise stronger control over their own email, their own hardware, their own data, it''s hard to know where to turn. Leaving your computer in a company''s hands is quite literally the only option.</p>', '', 1, 8, '2015-08-18 21:20:19', 753, '', '2015-08-18 13:48:19', 753, 0, '0000-00-00 00:00:00', '2015-08-18 21:20:19', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 2, 2, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(2, 58, 'Art installation brings drone killings to life', 'art-installation-brings-drone-killings-to-life', '<p>It can often be hard to grasp what numbers really represent. The thousands of deaths caused by drone strikes in Pakistan, Yemen, and elsewhere over the years are easily obscured when they''re communicated simply as black print in a newspaper.</p>\r\n<p>A new installation by Los Angeles artist Jonathan Fletcher Moore seeks to make drone killings a bit less abstract. It''s called Artificial Killing Machine, and, as he writes, the goal of the project "is to make visible the invisible or that which is too concealed to perceive."</p>\r\n<p>The installation is made up of an array of 15 digitally actuated toy cap guns dangling from the ceiling. A small receiver unit controls the guns autonomously. The toy guns sit dormant until a message comes over the wire from The Bureau of Investigative Journalism, which collects data on drone strikes. When a strike occurs, the guns abruptly pop into action, and a thermal printer clinically records the strike onto a ledger that dangles to the floor.</p>\r\n<p>It''s a very smart way to simulate the reality of drone strikes. The impending danger silently floats above. The killing is performed by a "toy" that''s controlled remotely. And the killings are soullessly recorded. One can even sit under the installation for the full experience.</p>\r\n<p>Moore calls the installation a "data visualization project," adding that it explores the ideas of "people as statistics" and "the concept of game and childhood-play to express the uncertainty of war, technology, and social progress."</p>\r\n<p>Artificial Killing Machine was on display earlier this year in Los Angeles, but thankfully there''s a excellent video (above) of the installation in case you missed it. For more on the project, visit Moore''s website.</p>', '', 1, 10, '2015-08-17 21:21:12', 753, '', '2015-08-17 21:21:12', 0, 753, '2015-08-18 13:46:01', '2015-08-17 21:21:12', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 3, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(3, 59, 'Google delays its Project Ara modular smartphone until 2016', 'google-delays-its-project-ara-modular-smartphone-until-2016', '<p>Google is pushing back plans to release its deeply customizable Project Ara smartphone hardware until sometime in 2016. The Ara team today tweeted a message acknowledging the delay and shift away from plans to test out the modular phone project in Puerto Rico later this year. But Google was also quick to note that it''s in the process of scouting "a few locations in the US" for Ara. Google''s explanation for the change suggests that the team has been hard at work to make Ara a reality. "Lots of iterations... more than we thought," the company tweeted.</p>\r\n<p> </p>\r\n<p>Project Ara allows users to swap out and upgrade the core components of a smartphone (processor, camera, etc.) individually rather than replace the whole device. It represents a dramatic rethinking of the mobile phone, and attendees at Google I/O were thrilled when the company showed a working prototype on stage in May. The progression to a consumer product seems to be taking a bit longer than anticipated, however. Google had originally aimed to have between 20 and 30 Ara modules available for the now-scrapped Puerto Rico pilot.</p>', '', 1, 8, '2015-08-16 21:22:19', 753, '', '2015-08-18 13:47:49', 753, 0, '0000-00-00 00:00:00', '2015-08-16 21:22:19', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 2, 1, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(4, 60, 'The BMW Concept M4 GTS is an M4 on steroids — and you''ll be able to buy it', 'the-bmw-concept-m4-gts-is-an-m4-on-steroids-and-you-ll-be-able-to-buy-it', '<p>BMW has a reputation of releasing uprated M3s over the years, going all the way back to the legendary E30 of the ’80s and early ’90s. With some rare, watered-down exceptions, though — the E46 ZCP and E92 Lime Rock Park Edition, for instance — they haven''t made it to the US. That changes with the new M4 GTS, being shown in concept form at Pebble Beach this week.</p>\r\n<p>Like the last-generation M3 GTS, the Concept M4 GTS is focused on shaving weight and boosting power to help transform the car from a road machine into a road-track hybrid. It looks like BMW isn''t talking exact numbers yet, but the GTS will get a boost over the standard M4''s 425 horsepower thanks to water injection, which sprays a fine mist into the engine''s intake manifold. That keeps it cooler, which allows the turbocharger to operate at higher boost without compromising reliability. (M3 engines have generally been reliable over the years, apart from a nasty issue early in the E46''s run that eventually got fixed.)</p>\r\n<p>Other performance-oriented changes on the GTS include a hood made of carbon fiber reinforced plastic (CFRP) — the same strong, ultra-lightweight material used extensively on the i3 and i8 — instead of aluminum, and a manually adjustable splitter and wing. (And, goodness, what a wing it is.)</p>\r\n<p>The car is painted in a menacing, matte dark gray trimmed with orange, just to make sure everyone on the road realizes you''re not driving a workaday M4. In back, the concept is fitted with the OLED taillights that BMW has been touting lately, though it''s not clear whether they''ll make it to the production model.</p>\r\n<p>There''s no word yet on exactly when this is going on sale, but it''ll be a limited-production affair — so be ready to get your deposit in very, very quickly.</p>', '', 1, 10, '2015-08-15 21:23:06', 753, '', '2015-08-18 13:47:40', 753, 0, '0000-00-00 00:00:00', '2015-08-15 21:23:06', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 2, 2, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(5, 61, 'How to buy an iPhone in America', 'how-to-buy-an-iphone-in-america', '<p>Here''s a weird thought experiment I''ve been noodling on for the past couple of weeks. When Apple announces the next iPhone next month, what are the prices that it''s going to flash on screen?</p>\r\n<p>Since last September, we''ve experienced a kind of revolution in wireless plans here in the US. Following T-Mobile, the big carriers have essentially jettisoned contracts and contract pricing for most of their new customers (though you can find them if you know where to look). So Apple probably can''t put up that traditional $199 on-contract starting price up on the big screen. Instead, it may have to put up the full price, or maybe the cost of the full price divided by 24. Or maybe something else entirely.</p>\r\n<p>Our whole concept of how much an iPhone — or any phone — costs is getting blown up here in the US. Or better said: it''s getting normalized, so that we know the actual cost of a phone instead of having it hidden in the depths of monthly service plans.</p>\r\n<p>Knowing that price would be great, but carriers can''t seem to help themselves when it comes to creating complicated and opaque payment plans. The latest come from Sprint and T-Mobile, who want you to buy an iPhone right now even though they know, and you know, and they know that you know that a new one is right around the corner. So they''re offering you the chance to upgrade a mere month or two after you buy an iPhone.</p>\r\n<p>These shenanigans apply to more than just the iPhone, of course, but right now it''s at the epicenter of these leasing and early-upgrade options. And so far as we can tell, most of these plans end up being bad deals unless you''re so eager to not have to resell your old phone that you''re willing to pay extra for the privilege. It''s the car leasing model on a smaller (or maybe bigger) scale, with all the consumer confusion and head games that go with it.</p>\r\n<p>So here, forthwith, is a guide to buying an iPhone from a major US carrier. We didn''t follow every path down to the final cost — in part because the final cost with many of these plans depends on your credit and the phase of the Moon when you buy it. But maybe, just maybe, we nailed the confusing experience you''re in for when you walk into most of these stores.</p>\r\n<p>Or, you know, you could just buy the phone outright. Increasingly, more and more consumers are finally figuring out that''s the best option for them.</p>', '', 1, 8, '2015-08-17 21:23:48', 753, '', '2015-08-17 21:23:48', 0, 0, '0000-00-00 00:00:00', '2015-08-17 21:23:48', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, '', '', 1, 2, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(6, 62, 'US gives Shell the final approval it needs to drill for oil in the Arctic', 'us-gives-shell-the-final-approval-it-needs-to-drill-for-oil-in-the-arctic', '<p>The US government has given Royal Dutch Shell the final approval it needs to drill for oil below the Arctic Ocean floor, off Alaska''s northwest coast. Shell plans to drill two exploration wells before late September, when the open-water season ends.</p>\r\n<p>US officials approved the permit after Shell bought technology that should help avoid well blowouts. Shell had previously only been allowed to drill the top sections of the two wells located in the Chukchi Sea because an important piece of equipment — called the "capping stack" — needed to be repaired in Portland, Oregon, reports the Associated Press. Now that the icebreaker carrying the equipment has made it to Alaska, Shell is free to drill at about 8,000 feet below the ocean floor for the first time in over 20 years.</p>\r\n<p>"We will continue to monitor their work around the clock to ensure the utmost safety and environmental stewardship," Brian Salerno, Director of the US Bureau of Safety and Environmental Enforcement, said in a statement.</p>\r\n<p>The oil giant has faced a lot of opposition from environmental activists over its activities in the Arctic. Last month, Greenpeace activists tried to stop Shell''s vessel from leaving Portland by dangling themselves from a bridge, blocking the icebreaker''s path. They managed to stall the vessel for a while, but the ship made it through after law-enforcement officials removed three of the 13 activists dangling from the bridge.</p>\r\n<p>Shell has already spent over $7 billion on exploration in the Chukchi Sea and in the Beaufort Sea, off Alaska''s north coast. The US Arctic waters contain about 26 billion barrels of recoverable oil, according to the US Geological Survey.</p>', '', 1, 9, '2015-08-16 21:24:16', 753, '', '2015-08-18 13:46:51', 753, 0, '0000-00-00 00:00:00', '2015-08-16 21:24:16', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 2, 2, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(7, 63, 'Google Maps can now tell you if it’s worth installing solar panels on your roof', 'google-maps-can-now-tell-you-if-it-s-worth-installing-solar-panels-on-your-roof', '<p>Google wants to help you harness the power of the sun. A new service called Project Sunroof aims to provide a "treasure map" of solar energy with the help of Google Maps. Sunroof gives homeowners detailed information about how much solar power their roof can generate and how much money they could save on electricity costs by adding solar panels.</p>\r\n<p>Sunroof uses data from Google Maps that previously had no practical application. For instance, Sunroof uses Maps’ 3D-modeling to calculate the amount of space a building’s roof has for solar panels. The service also analyzes the positioning of the sun over the course of a year, as well as the type of cloud cover and temperature the neighborhood usually experiences. It even considers the amount of shade cast by nearby objects.</p>\r\n<p>Switching to solar energy can be a win-win scenario for many households. Harnessing a free power source can help save money on the electric bill while ever-so-slightly decreasing the world''s dependance on greenhouse-gas-producing fossil fuels. But it''s possible your home doesn''t get enough sunlight, and it can be hard to know exactly how much money you''ll save. Sunroof can tell users how many hours of usable sunlight they''ll get a year, as well as how much available space they have for solar panels on their roof.</p>\r\n<p>If a family decides those cost-saving benefits are good enough, Sunroof will suggest installers nearby who can load the panels. Installing solar panels isn''t cheap, costing upwards of $20,000, but the average homeowner can save about $20,000 by switching to solar energy — if their home is in the right spot.</p>\r\n<p>Right now, Project Sunroof is only available for people living in Boston, San Francisco, and Fresno, but Google plans to expand the service to the entire country.</p>', '', 1, 9, '2015-08-15 21:25:05', 753, '', '2015-08-18 13:46:45', 753, 0, '0000-00-00 00:00:00', '2015-08-15 21:25:05', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 2, 1, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(8, 64, 'Watch as astronauts soar over an Aurora Borealis in the space station', 'watch-as-astronauts-soar-over-an-aurora-borealis-in-the-space-station', '<p>Space is a remarkable place, and right now, NASA astronaut Scott Kelly has the best seat in the house for watching its cosmic wonders unfold. Last night, Kelly posted a brief video to let us join in on his incredible view as he soared over a stunning Aurora Borealis from aboard the International Space Station at roughly 17,000 mph.</p>\r\n<p>This isn''t your run-of-the-mill snapshot of the Northern Lights. The 10-second clip catches the spectacular moment right as the vibrant greens and violet swirls of light meet the blinding white of the sunrise. The scene, however brief, is otherworldly and reminiscent of fantastic sci-fi visages from the arts. It looks like something out of a Mass Effect cutscene or the psychedelic trip to "The Infinite and Beyond" in 2001: A Space Odyssey. Except this is no piece of fiction: this is real life, and it''s right here near Earth.</p>\r\n<p>Kelly is in the middle of his record-breaking Year in Space mission with NASA. He, alongside Russian cosmonaut Mikhail Kornienko, are 141 days into their planned 342-day stay at ISS. They''re set to return to Earth next spring, but they''ll certainly see quite a few more amazing sights before they come home. Be sure to follow Scott Kelly on Twitter if you want updates on his daily life at the station.</p>', '', 1, 9, '2015-08-17 21:25:34', 753, '', '2015-08-17 21:25:34', 0, 753, '2015-08-18 13:45:57', '2015-08-17 21:25:34', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(9, 65, 'Samsung gives its premium headphones what they really need: a gold color option', 'samsung-gives-its-premium-headphones-what-they-really-need-a-gold-color-option', '<p>Samsung has been slowly building up its premium range of Level headphones over the past few months, hoping to take on Beats in this lucrative market with its own line of stylish and colorful audio products. Today, the South Korean company announced the latest addition to its line-up: the new Level On Wireless Pro headphones, offering Ultra High Quality Audio (promising sound quality better than CDs with the right audio format) and — wait for it — a gold color option. Because as Beats has shown, nothing says professional audio quality better than flashy design.</p>\r\n<p>It''s interesting that out of the whole of the Level range, only the new Pro wireless headphones are available in what Samsung is calling "premium gold." (The nearly identical Level On Wireless headphones have the same noise-canceling feature and touch-sensitive controls but only come in black, white, blue, and red.) And it''s not that Samsung makes bad headphones at all —  we rather liked the company''s over-ear Level Over headphones apart from the fact they were huge — but this shows how difficult it is to differentiate products, even within your own company. But when companies are signing up superstars like Cristiano Ronaldo to sell headphones, a gold color option alone isn''t enough. The Ultra High Quality Audio better live up to its name instead.</p>', '', 1, 10, '2015-08-16 21:26:06', 753, '', '2015-08-18 13:46:18', 753, 0, '0000-00-00 00:00:00', '2015-08-16 21:26:06', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 2, 1, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(10, 66, 'BMW fixed the 3.0 CSL Hommage concept car, and now it looks amazing', 'bmw-fixed-the-3-0-csl-hommage-concept-car-and-now-it-looks-amazing', '<p>When it was introduced in May, BMW''s 3.0 CSL Hommage was met with mixed reactions — the car''s lines just didn''t seem to flow correctly. It definitely didn''t feel like a fitting tribute to the original 3.0CSL of the early ’70s, one of the prettiest and most celebrated variants of one of the best cars BMW has ever made.</p>\r\n<p>But rather than giving up and moving on, BMW is back with a second version of the car — the 3.0 CSL Hommage R — which is debuting at the famed Pebble Beach Concours d''Elegance this week. And strangely enough, against all odds, I think they may have actually managed to fix it.</p>\r\n<p>The R version was designed to celebrate BMW North America''s 40th anniversary and the original 3.0 CSL''s successes on the track in 1975. Gone is the garish yellow of the earlier concept car, replaced with a very traditional BMW racing livery — white, trimmed with the red and two shades of blue of the company''s Motorsport division. Instead of fighting the car''s odd lines, the new colors complement them, paired with angry-looking gold wheels that are track-ready.</p>\r\n<p>Inside, there''s not much going on — that''s because most of the instrumentation is designed to route through to the driver''s helmet visor. It sounds like science fiction, but at this point, it isn''t; augmented reality is popping up on a regular basis nowadays, and even automakers have started showing working concepts.</p>\r\n<p>Clearly, this isn''t a production car — but now that BMW has made two versions of it, odds are growing that we''re looking at some very real design language we can expect to see in future models that are rolling off the line. Now that they''ve gotten it right with the R, I''m okay with that.</p>', '', 1, 10, '2015-08-15 21:27:00', 753, '', '2015-08-18 13:45:51', 753, 0, '0000-00-00 00:00:00', '2015-08-15 21:27:00', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 4, 0, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', '');
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2015 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"d9470831af43128326200290769b9fa1"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(101, 'mainmenu', 'Home', 'home', '', 'home', 'index.php?option=com_content&view=categories&id=0', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_base_description":"","categories_description":"","maxLevelcat":"","show_empty_categories_cat":"","show_subcat_desc_cat":"","show_cat_num_articles_cat":"","show_category_title":"","show_description":"","show_description_image":"","maxLevel":"","show_empty_categories":"","show_no_articles":"","show_subcat_desc":"","show_cat_num_articles":"","num_leading_articles":"1","num_intro_articles":"4","num_columns":"2","num_links":"4","multi_column_order":"","show_subcategory_content":"","orderby_pri":"","orderby_sec":"","order_date":"","show_pagination":"2","show_pagination_results":"1","show_pagination_limit":"","filter_field":"","show_headings":"","list_show_date":"","date_format":"","list_show_hits":"","list_show_author":"","display_num":"10","show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_readmore":"","show_readmore_title":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_noauth":"","show_feed_link":"1","feed_summary":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":"1","page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 41, 42, 1, '*', 0);
...
('hehaf0hg4pnliu3oon259v0pr6', 1, 0, '1439905700', '__default|a:8:{s:15:"session.counter";i:52;s:19:"session.timer.start";i:1439905443;s:18:"session.timer.last";i:1439905699;s:17:"session.timer.now";i:1439905700;s:22:"session.client.browser";s:115:"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.155 Safari/537.36";s:8:"registry";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":3:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:5:"en-GB";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}s:11:"com_content";O:8:"stdClass":1:{s:4:"edit";O:8:"stdClass":1:{s:7:"article";O:8:"stdClass":2:{s:2:"id";a:1:{i:1;i:8;}s:4:"data";N;}}}}s:9:"separator";s:1:".";}s:4:"user";O:5:"JUser":28:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"753";s:4:"name";s:10:"Super User";s:8:"username";s:10:"adrielcafe";s:5:"email";s:17:"ac@adrielcafe.com";s:8:"password";s:60:"$2y$10$g2Fcqu5wvEfXWpWcGBwyUu60d0P14n3e9EpRe7sZjgUyVz1tV/SNq";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2015-08-17 21:06:02";s:13:"lastvisitDate";s:19:"2015-08-18 12:22:58";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:12:"requireReset";s:1:"0";s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"13764de3c7e643f88d658937b7f55edd";}', 753, 'adrielcafe');
...
(1, 8, 5, '', '2015-08-17 21:15:05', 753, 545, 'be1663348144d3d7d7a2c0a107d83bcd5f9addc6', '{"id":8,"asset_id":54,"parent_id":"1","lft":"11","rgt":12,"level":1,"path":null,"extension":"com_content","title":"Tech","alias":"tech","note":"","description":"","published":"1","checked_out":null,"checked_out_time":null,"access":"1","params":"{\\"category_layout\\":\\"\\",\\"image\\":\\"\\",\\"image_alt\\":\\"\\"}","metadesc":"","metakey":"","metadata":"{\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":"753","created_time":"2015-08-17 21:15:05","modified_user_id":null,"modified_time":"2015-08-17 21:15:05","hits":"0","language":"*","version":null}', 0),
(2, 9, 5, '', '2015-08-17 21:15:29', 753, 551, '52336a4460db8d63c45de9b16c3ccc033a1ae4d0', '{"id":9,"asset_id":55,"parent_id":"1","lft":"13","rgt":14,"level":1,"path":null,"extension":"com_content","title":"Science","alias":"science","note":"","description":"","published":"1","checked_out":null,"checked_out_time":null,"access":"1","params":"{\\"category_layout\\":\\"\\",\\"image\\":\\"\\",\\"image_alt\\":\\"\\"}","metadesc":"","metakey":"","metadata":"{\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":"753","created_time":"2015-08-17 21:15:29","modified_user_id":null,"modified_time":"2015-08-17 21:15:29","hits":"0","language":"*","version":null}', 0),
(3, 10, 5, '', '2015-08-17 21:16:23', 753, 550, '6ac20a3c39e82b28abc037c7f9fbef8765b90bf8', '{"id":10,"asset_id":56,"parent_id":"1","lft":"15","rgt":16,"level":1,"path":null,"extension":"com_content","title":"Design","alias":"design","note":"","description":"","published":"1","checked_out":null,"checked_out_time":null,"access":"1","params":"{\\"category_layout\\":\\"\\",\\"image\\":\\"\\",\\"image_alt\\":\\"\\"}","metadesc":"","metakey":"","metadata":"{\\"author\\":\\"\\",\\"robots\\":\\"\\"}","created_user_id":"753","created_time":"2015-08-17 21:16:23","modified_user_id":null,"modified_time":"2015-08-17 21:16:23","hits":"0","language":"*","version":null}', 0),
(4, 1, 1, '', '2015-08-17 21:20:19', 753, 5417, 'ff203c328bcfc1dd190ae54b06d62b23e5e80f0b', '{"id":1,"asset_id":57,"title":"Windows 10 is the end of cloud-free computing","alias":"windows-10-is-the-end-of-cloud-free-computing","introtext":"<p>In the weeks after its release, Windows 10 users have noticed something strange \\u2014 it''s always phoning home. Last week, an Ars Technica investigation found Windows computers sending data back to Microsoft servers even after services like Cortana and OneDrive had been disabled, in one case even sending back a message as soon as users hit the Start button.<\\/p>\\r\\n<p>It''s a telling change for Microsoft \\u2014 the last major tech company built on self-contained software \\u2014 and it\\u2019s set off a string of related worries. If any Microsoft users had been scared off by data collection from Google and Apple, they now have nowhere to turn. Reached by Ars Technica, the company was quick to defend itself, saying, \\"No query or search usage data is sent to Microsoft, in accordance with the customer''s chosen privacy settings.\\" Most of the data is anonymized usage logging, not inherently a privacy concern, but the fact remains: using Windows 10 requires constant access to Microsoft''s remote servers, and that access goes both ways.<\\/p>\\r\\n<p>In 2015, this is simply how computing works. Consumers expect smart recommendations and continually improving services. We expect computers \\u2014 all computers \\u2014 to be able to answer any question at any time. In return, companies get constant access to your computer for data collection, automatic updates, and offboard processing. This isn''t an option anymore; it''s the default. And anyone who doesn''t like the deal is going to have a very hard time using today''s computers.<\\/p>\\r\\n<p>Mobile tech works this way out of necessity \\u2014 there simply isn''t the processing power to take on more complex tasks \\u2014 and over the last five years, even more powerful computers have followed that model. It''s essentially the premise of all Google''s software efforts. Most Chromebooks are constantly feeding data back to Google servers, even though it happens more often through Drive or Search services than the OS itself. If the services are going to improve, engineers need to know what''s working and what isn''t \\u2014 and since the services themselves are all free, some level of data-targeted advertising is inevitable. Companies go back and forth on how much to collect and how much to anonymize, but the overall choices have turned out very much the same. Apple ran into its own version of this problem when Yosemite launched last year: the revamped Spotlight Search function fed queries back to Apple Headquarters. But if Spotlight is going to handle web-facing queries like \\"restaurants near me,\\" what else could it do?<\\/p>\\r\\n<p>For a long time, Microsoft was the exception to this rule. The company has rolled out lots of cloud services, but they''ve been discrete offerings, rarely baked into the OS itself, in part because the new approach cut against Microsoft''s traditional strengths. That logic changed with Windows 10 because it had to. If Microsoft is going to steal users back from Apple and Google, it needs to match services like Siri and Google Voice, which means plugging into the cloud at the deepest possible level.<\\/p>\\r\\n<p>But while software has changed, the world has been changing around it. Corporate clouds aren''t as secure as they once were, and we''ve seen them compromised by government spies and Redditors alike. Last year, Microsoft chased down an in-house leaker by peeking into a private blogger''s Hotmail account, offering profuse apologies after the fact. But for anyone who wants to exercise stronger control over their own email, their own hardware, their own data, it''s hard to know where to turn. Leaving your computer in a company''s hands is quite literally the only option.<\\/p>","fulltext":"","state":1,"catid":"8","created":"2015-08-17 21:20:19","created_by":"753","created_by_alias":"","modified":"2015-08-17 21:20:19","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2015-08-17 21:20:19","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(5, 2, 1, '', '2015-08-17 21:21:12', 753, 3506, '3f22ca358007d49a7017c717577f90acf1a74bfb', '{"id":2,"asset_id":58,"title":"Art installation brings drone killings to life","alias":"art-installation-brings-drone-killings-to-life","introtext":"<p>It can often be hard to grasp what numbers really represent. The thousands of deaths caused by drone strikes in Pakistan, Yemen, and elsewhere over the years are easily obscured when they''re communicated simply as black print in a newspaper.<\\/p>\\r\\n<p>A new installation by Los Angeles artist Jonathan Fletcher Moore seeks to make drone killings a bit less abstract. It''s called Artificial Killing Machine, and, as he writes, the goal of the project \\"is to make visible the invisible or that which is too concealed to perceive.\\"<\\/p>\\r\\n<p>The installation is made up of an array of 15 digitally actuated toy cap guns dangling from the ceiling. A small receiver unit controls the guns autonomously. The toy guns sit dormant until a message comes over the wire from The Bureau of Investigative Journalism, which collects data on drone strikes. When a strike occurs, the guns abruptly pop into action, and a thermal printer clinically records the strike onto a ledger that dangles to the floor.<\\/p>\\r\\n<p>It''s a very smart way to simulate the reality of drone strikes. The impending danger silently floats above. The killing is performed by a \\"toy\\" that''s controlled remotely. And the killings are soullessly recorded. One can even sit under the installation for the full experience.<\\/p>\\r\\n<p>Moore calls the installation a \\"data visualization project,\\" adding that it explores the ideas of \\"people as statistics\\" and \\"the concept of game and childhood-play to express the uncertainty of war, technology, and social progress.\\"<\\/p>\\r\\n<p>Artificial Killing Machine was on display earlier this year in Los Angeles, but thankfully there''s a excellent video (above) of the installation in case you missed it. For more on the project, visit Moore''s website.<\\/p>","fulltext":"","state":1,"catid":"10","created":"2015-08-17 21:21:12","created_by":"753","created_by_alias":"","modified":"2015-08-17 21:21:12","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2015-08-17 21:21:12","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(6, 3, 1, '', '2015-08-17 21:22:19', 753, 2890, '2067a7b138b3ac5fa9a6377651b8b7347fbb37ec', '{"id":3,"asset_id":59,"title":"Google delays its Project Ara modular smartphone until 2016","alias":"google-delays-its-project-ara-modular-smartphone-until-2016","introtext":"<p>Google is pushing back plans to release its deeply customizable Project Ara smartphone hardware until sometime in 2016. The Ara team today tweeted a message acknowledging the delay and shift away from plans to test out the modular phone project in Puerto Rico later this year. But Google was also quick to note that it''s in the process of scouting \\"a few locations in the US\\" for Ara. Google''s explanation for the change suggests that the team has been hard at work to make Ara a reality. \\"Lots of iterations... more than we thought,\\" the company tweeted.<\\/p>\\r\\n<p>\\u00a0<\\/p>\\r\\n<p>Project Ara allows users to swap out and upgrade the core components of a smartphone (processor, camera, etc.) individually rather than replace the whole device. It represents a dramatic rethinking of the mobile phone, and attendees at Google I\\/O were thrilled when the company showed a working prototype on stage in May. The progression to a consumer product seems to be taking a bit longer than anticipated, however. Google had originally aimed to have between 20 and 30 Ara modules available for the now-scrapped Puerto Rico pilot.<\\/p>","fulltext":"","state":1,"catid":"8","created":"2015-08-17 21:22:19","created_by":"753","created_by_alias":"","modified":"2015-08-17 21:22:19","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2015-08-17 21:22:19","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(7, 4, 1, '', '2015-08-17 21:23:06', 753, 3628, '2555aedba6d3765cac1dcf42cef9c107d5c046eb', '{"id":4,"asset_id":60,"title":"The BMW Concept M4 GTS is an M4 on steroids \\u2014 and you''ll be able to buy it","alias":"the-bmw-concept-m4-gts-is-an-m4-on-steroids-and-you-ll-be-able-to-buy-it","introtext":"<p>BMW has a reputation of releasing uprated M3s over the years, going all the way back to the legendary E30 of the \\u201980s and early \\u201990s. With some rare, watered-down exceptions, though \\u2014 the E46 ZCP and E92 Lime Rock Park Edition, for instance \\u2014 they haven''t made it to the US. That changes with the new M4 GTS, being shown in concept form at Pebble Beach this week.<\\/p>\\r\\n<p>Like the last-generation M3 GTS, the Concept M4 GTS is focused on shaving weight and boosting power to help transform the car from a road machine into a road-track hybrid. It looks like BMW isn''t talking exact numbers yet, but the GTS will get a boost over the standard M4''s 425 horsepower thanks to water injection, which sprays a fine mist into the engine''s intake manifold. That keeps it cooler, which allows the turbocharger to operate at higher boost without compromising reliability. (M3 engines have generally been reliable over the years, apart from a nasty issue early in the E46''s run that eventually got fixed.)<\\/p>\\r\\n<p>Other performance-oriented changes on the GTS include a hood made of carbon fiber reinforced plastic (CFRP) \\u2014 the same strong, ultra-lightweight material used extensively on the i3 and i8 \\u2014 instead of aluminum, and a manually adjustable splitter and wing. (And, goodness, what a wing it is.)<\\/p>\\r\\n<p>The car is painted in a menacing, matte dark gray trimmed with orange, just to make sure everyone on the road realizes you''re not driving a workaday M4. In back, the concept is fitted with the OLED taillights that BMW has been touting lately, though it''s not clear whether they''ll make it to the production model.<\\/p>\\r\\n<p>There''s no word yet on exactly when this is going on sale, but it''ll be a limited-production affair \\u2014 so be ready to get your deposit in very, very quickly.<\\/p>","fulltext":"","state":1,"catid":"10","created":"2015-08-17 21:23:06","created_by":"753","created_by_alias":"","modified":"2015-08-17 21:23:06","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2015-08-17 21:23:06","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(8, 5, 1, '', '2015-08-17 21:23:48', 753, 4135, '358ae285540b09a13363a1c9af2166dc50ec6b20', '{"id":5,"asset_id":61,"title":"How to buy an iPhone in America","alias":"how-to-buy-an-iphone-in-america","introtext":"<p>Here''s a weird thought experiment I''ve been noodling on for the past couple of weeks. When Apple announces the next iPhone next month, what are the prices that it''s going to flash on screen?<\\/p>\\r\\n<p>Since last September, we''ve experienced a kind of revolution in wireless plans here in the US. Following T-Mobile, the big carriers have essentially jettisoned contracts and contract pricing for most of their new customers (though you can find them if you know where to look). So Apple probably can''t put up that traditional $199 on-contract starting price up on the big screen. Instead, it may have to put up the full price, or maybe the cost of the full price divided by 24. Or maybe something else entirely.<\\/p>\\r\\n<p>Our whole concept of how much an iPhone \\u2014 or any phone \\u2014 costs is getting blown up here in the US. Or better said: it''s getting normalized, so that we know the actual cost of a phone instead of having it hidden in the depths of monthly service plans.<\\/p>\\r\\n<p>Knowing that price would be great, but carriers can''t seem to help themselves when it comes to creating complicated and opaque payment plans. The latest come from Sprint and T-Mobile, who want you to buy an iPhone right now even though they know, and you know, and they know that you know that a new one is right around the corner. So they''re offering you the chance to upgrade a mere month or two after you buy an iPhone.<\\/p>\\r\\n<p>These shenanigans apply to more than just the iPhone, of course, but right now it''s at the epicenter of these leasing and early-upgrade options. And so far as we can tell, most of these plans end up being bad deals unless you''re so eager to not have to resell your old phone that you''re willing to pay extra for the privilege. It''s the car leasing model on a smaller (or maybe bigger) scale, with all the consumer confusion and head games that go with it.<\\/p>\\r\\n<p>So here, forthwith, is a guide to buying an iPhone from a major US carrier. We didn''t follow every path down to the final cost \\u2014 in part because the final cost with many of these plans depends on your credit and the phase of the Moon when you buy it. But maybe, just maybe, we nailed the confusing experience you''re in for when you walk into most of these stores.<\\/p>\\r\\n<p>Or, you know, you could just buy the phone outright. Increasingly, more and more consumers are finally figuring out that''s the best option for them.<\\/p>","fulltext":"","state":1,"catid":"8","created":"2015-08-17 21:23:48","created_by":"753","created_by_alias":"","modified":"2015-08-17 21:23:48","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2015-08-17 21:23:48","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(9, 6, 1, '', '2015-08-17 21:24:16', 753, 3514, '95e4bcb62e5e9d60eb6bcdf78f784b840ca40add', '{"id":6,"asset_id":62,"title":"US gives Shell the final approval it needs to drill for oil in the Arctic","alias":"us-gives-shell-the-final-approval-it-needs-to-drill-for-oil-in-the-arctic","introtext":"<p>The US government has given Royal Dutch Shell the final approval it needs to drill for oil below the Arctic Ocean floor, off Alaska''s northwest coast. Shell plans to drill two exploration wells before late September, when the open-water season ends.<\\/p>\\r\\n<p>US officials approved the permit after Shell bought technology that should help avoid well blowouts. Shell had previously only been allowed to drill the top sections of the two wells located in the Chukchi Sea because an important piece of equipment \\u2014 called the \\"capping stack\\" \\u2014 needed to be repaired in Portland, Oregon, reports the Associated Press. Now that the icebreaker carrying the equipment has made it to Alaska, Shell is free to drill at about 8,000 feet below the ocean floor for the first time in over 20 years.<\\/p>\\r\\n<p>\\"We will continue to monitor their work around the clock to ensure the utmost safety and environmental stewardship,\\" Brian Salerno, Director of the US Bureau of Safety and Environmental Enforcement, said in a statement.<\\/p>\\r\\n<p>The oil giant has faced a lot of opposition from environmental activists over its activities in the Arctic. Last month, Greenpeace activists tried to stop Shell''s vessel from leaving Portland by dangling themselves from a bridge, blocking the icebreaker''s path. They managed to stall the vessel for a while, but the ship made it through after law-enforcement officials removed three of the 13 activists dangling from the bridge.<\\/p>\\r\\n<p>Shell has already spent over $7 billion on exploration in the Chukchi Sea and in the Beaufort Sea, off Alaska''s north coast. The US Arctic waters contain about 26 billion barrels of recoverable oil, according to the US Geological Survey.<\\/p>","fulltext":"","state":1,"catid":"9","created":"2015-08-17 21:24:16","created_by":"753","created_by_alias":"","modified":"2015-08-17 21:24:16","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2015-08-17 21:24:16","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(10, 7, 1, '', '2015-08-17 21:25:05', 753, 3640, 'cf0cd2bd8052735d99aa35410225ccd48610705b', '{"id":7,"asset_id":63,"title":"Google Maps can now tell you if it\\u2019s worth installing solar panels on your roof","alias":"google-maps-can-now-tell-you-if-it-s-worth-installing-solar-panels-on-your-roof","introtext":"<p>Google wants to help you harness the power of the sun. A new service called Project Sunroof aims to provide a \\"treasure map\\" of solar energy with the help of Google Maps. Sunroof gives homeowners detailed information about how much solar power their roof can generate and how much money they could save on electricity costs by adding solar panels.<\\/p>\\r\\n<p>Sunroof uses data from Google Maps that previously had no practical application. For instance, Sunroof uses Maps\\u2019 3D-modeling to calculate the amount of space a building\\u2019s roof has for solar panels. The service also analyzes the positioning of the sun over the course of a year, as well as the type of cloud cover and temperature the neighborhood usually experiences. It even considers the amount of shade cast by nearby objects.<\\/p>\\r\\n<p>Switching to solar energy can be a win-win scenario for many households. Harnessing a free power source can help save money on the electric bill while ever-so-slightly decreasing the world''s dependance on greenhouse-gas-producing fossil fuels. But it''s possible your home doesn''t get enough sunlight, and it can be hard to know exactly how much money you''ll save. Sunroof can tell users how many hours of usable sunlight they''ll get a year, as well as how much available space they have for solar panels on their roof.<\\/p>\\r\\n<p>If a family decides those cost-saving benefits are good enough, Sunroof will suggest installers nearby who can load the panels. Installing solar panels isn''t cheap, costing upwards of $20,000, but the average homeowner can save about $20,000 by switching to solar energy \\u2014 if their home is in the right spot.<\\/p>\\r\\n<p>Right now, Project Sunroof is only available for people living in Boston, San Francisco, and Fresno, but Google plans to expand the service to the entire country.<\\/p>","fulltext":"","state":1,"catid":"9","created":"2015-08-17 21:25:05","created_by":"753","created_by_alias":"","modified":"2015-08-17 21:25:05","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2015-08-17 21:25:05","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(11, 8, 1, '', '2015-08-17 21:25:34', 753, 3077, '1c71490b6da0c150bc87c372acbad77b89ce5099', '{"id":8,"asset_id":64,"title":"Watch as astronauts soar over an Aurora Borealis in the space station","alias":"watch-as-astronauts-soar-over-an-aurora-borealis-in-the-space-station","introtext":"<p>Space is a remarkable place, and right now, NASA astronaut Scott Kelly has the best seat in the house for watching its cosmic wonders unfold. Last night, Kelly posted a brief video to let us join in on his incredible view as he soared over a stunning Aurora Borealis from aboard the International Space Station at roughly 17,000 mph.<\\/p>\\r\\n<p>This isn''t your run-of-the-mill snapshot of the Northern Lights. The 10-second clip catches the spectacular moment right as the vibrant greens and violet swirls of light meet the blinding white of the sunrise. The scene, however brief, is otherworldly and reminiscent of fantastic sci-fi visages from the arts. It looks like something out of a Mass Effect cutscene or the psychedelic trip to \\"The Infinite and Beyond\\" in 2001: A Space Odyssey. Except this is no piece of fiction: this is real life, and it''s right here near Earth.<\\/p>\\r\\n<p>Kelly is in the middle of his record-breaking Year in Space mission with NASA. He, alongside Russian cosmonaut Mikhail Kornienko, are 141 days into their planned 342-day stay at ISS. They''re set to return to Earth next spring, but they''ll certainly see quite a few more amazing sights before they come home. Be sure to follow Scott Kelly on Twitter if you want updates on his daily life at the station.<\\/p>","fulltext":"","state":1,"catid":"9","created":"2015-08-17 21:25:34","created_by":"753","created_by_alias":"","modified":"2015-08-17 21:25:34","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2015-08-17 21:25:34","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(12, 9, 1, '', '2015-08-17 21:26:06', 753, 3168, 'e81e7c73a6384cead4ca6e9af42abe268b095bfe', '{"id":9,"asset_id":65,"title":"Samsung gives its premium headphones what they really need: a gold color option","alias":"samsung-gives-its-premium-headphones-what-they-really-need-a-gold-color-option","introtext":"<p>Samsung has been slowly building up its premium range of Level headphones over the past few months, hoping to take on Beats in this lucrative market with its own line of stylish and colorful audio products. Today, the South Korean company announced the latest addition to its line-up: the new Level On Wireless Pro headphones, offering Ultra High Quality Audio (promising sound quality better than CDs with the right audio format) and \\u2014 wait for it \\u2014 a gold color option. Because as Beats has shown, nothing says professional audio quality better than flashy design.<\\/p>\\r\\n<p>It''s interesting that out of the whole of the Level range, only the new Pro wireless headphones are available in what Samsung is calling \\"premium gold.\\" (The nearly identical Level On Wireless headphones have the same noise-canceling feature and touch-sensitive controls but only come in black, white, blue, and red.) And it''s not that Samsung makes bad headphones at all \\u2014 \\u00a0we rather liked the company''s over-ear Level Over headphones apart from the fact they were huge \\u2014 but this shows how difficult it is to differentiate products, even within your own company. But when companies are signing up superstars like Cristiano Ronaldo to sell headphones, a gold color option alone isn''t enough. The Ultra High Quality Audio better live up to its name instead.<\\/p>","fulltext":"","state":1,"catid":"10","created":"2015-08-17 21:26:06","created_by":"753","created_by_alias":"","modified":"2015-08-17 21:26:06","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2015-08-17 21:26:06","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(13, 10, 1, '', '2015-08-17 21:27:03', 753, 3531, 'e3be96982f7282d6a93fec6623ffeb678162e1d9', '{"id":10,"asset_id":66,"title":"BMW fixed the 3.0 CSL Hommage concept car, and now it looks amazing","alias":"bmw-fixed-the-3-0-csl-hommage-concept-car-and-now-it-looks-amazing","introtext":"<p>When it was introduced in May, BMW''s 3.0 CSL Hommage was met with mixed reactions \\u2014 the car''s lines just didn''t seem to flow correctly. It definitely didn''t feel like a fitting tribute to the original 3.0CSL of the early \\u201970s, one of the prettiest and most celebrated variants of one of the best cars BMW has ever made.<\\/p>\\r\\n<p>But rather than giving up and moving on, BMW is back with a second version of the car \\u2014 the 3.0 CSL Hommage R \\u2014 which is debuting at the famed Pebble Beach Concours d''Elegance this week. And strangely enough, against all odds, I think they may have actually managed to fix it.<\\/p>\\r\\n<p>The R version was designed to celebrate BMW North America''s 40th anniversary and the original 3.0 CSL''s successes on the track in 1975. Gone is the garish yellow of the earlier concept car, replaced with a very traditional BMW racing livery \\u2014 white, trimmed with the red and two shades of blue of the company''s Motorsport division. Instead of fighting the car''s odd lines, the new colors complement them, paired with angry-looking gold wheels that are track-ready.<\\/p>\\r\\n<p>Inside, there''s not much going on \\u2014 that''s because most of the instrumentation is designed to route through to the driver''s helmet visor. It sounds like science fiction, but at this point, it isn''t; augmented reality is popping up on a regular basis nowadays, and even automakers have started showing working concepts.<\\/p>\\r\\n<p>Clearly, this isn''t a production car \\u2014 but now that BMW has made two versions of it, odds are growing that we''re looking at some very real design language we can expect to see in future models that are rolling off the line. Now that they''ve gotten it right with the R, I''m okay with that.<\\/p>","fulltext":"","state":1,"catid":"10","created":"2015-08-17 21:27:03","created_by":"753","created_by_alias":"","modified":"2015-08-17 21:27:03","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2015-08-17 21:27:03","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(14, 10, 1, '', '2015-08-18 13:45:51', 753, 3550, '9fb09c4564885f6c99966298c5ba69616d2d759c', '{"id":10,"asset_id":"66","title":"BMW fixed the 3.0 CSL Hommage concept car, and now it looks amazing","alias":"bmw-fixed-the-3-0-csl-hommage-concept-car-and-now-it-looks-amazing","introtext":"<p>When it was introduced in May, BMW''s 3.0 CSL Hommage was met with mixed reactions \\u2014 the car''s lines just didn''t seem to flow correctly. It definitely didn''t feel like a fitting tribute to the original 3.0CSL of the early \\u201970s, one of the prettiest and most celebrated variants of one of the best cars BMW has ever made.<\\/p>\\r\\n<p>But rather than giving up and moving on, BMW is back with a second version of the car \\u2014 the 3.0 CSL Hommage R \\u2014 which is debuting at the famed Pebble Beach Concours d''Elegance this week. And strangely enough, against all odds, I think they may have actually managed to fix it.<\\/p>\\r\\n<p>The R version was designed to celebrate BMW North America''s 40th anniversary and the original 3.0 CSL''s successes on the track in 1975. Gone is the garish yellow of the earlier concept car, replaced with a very traditional BMW racing livery \\u2014 white, trimmed with the red and two shades of blue of the company''s Motorsport division. Instead of fighting the car''s odd lines, the new colors complement them, paired with angry-looking gold wheels that are track-ready.<\\/p>\\r\\n<p>Inside, there''s not much going on \\u2014 that''s because most of the instrumentation is designed to route through to the driver''s helmet visor. It sounds like science fiction, but at this point, it isn''t; augmented reality is popping up on a regular basis nowadays, and even automakers have started showing working concepts.<\\/p>\\r\\n<p>Clearly, this isn''t a production car \\u2014 but now that BMW has made two versions of it, odds are growing that we''re looking at some very real design language we can expect to see in future models that are rolling off the line. Now that they''ve gotten it right with the R, I''m okay with that.<\\/p>","fulltext":"","state":1,"catid":"10","created":"2015-08-15 21:27:00","created_by":"753","created_by_alias":"","modified":"2015-08-18 13:45:51","modified_by":"753","checked_out":"753","checked_out_time":"2015-08-18 13:45:32","publish_up":"2015-08-15 21:27:00","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":4,"ordering":"0","metakey":"","metadesc":"","access":"1","hits":"0","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(15, 9, 1, '', '2015-08-18 13:46:18', 753, 3187, '350e2b1233532500653b3d68377622b5ec253655', '{"id":9,"asset_id":"65","title":"Samsung gives its premium headphones what they really need: a gold color option","alias":"samsung-gives-its-premium-headphones-what-they-really-need-a-gold-color-option","introtext":"<p>Samsung has been slowly building up its premium range of Level headphones over the past few months, hoping to take on Beats in this lucrative market with its own line of stylish and colorful audio products. Today, the South Korean company announced the latest addition to its line-up: the new Level On Wireless Pro headphones, offering Ultra High Quality Audio (promising sound quality better than CDs with the right audio format) and \\u2014 wait for it \\u2014 a gold color option. Because as Beats has shown, nothing says professional audio quality better than flashy design.<\\/p>\\r\\n<p>It''s interesting that out of the whole of the Level range, only the new Pro wireless headphones are available in what Samsung is calling \\"premium gold.\\" (The nearly identical Level On Wireless headphones have the same noise-canceling feature and touch-sensitive controls but only come in black, white, blue, and red.) And it''s not that Samsung makes bad headphones at all \\u2014 \\u00a0we rather liked the company''s over-ear Level Over headphones apart from the fact they were huge \\u2014 but this shows how difficult it is to differentiate products, even within your own company. But when companies are signing up superstars like Cristiano Ronaldo to sell headphones, a gold color option alone isn''t enough. The Ultra High Quality Audio better live up to its name instead.<\\/p>","fulltext":"","state":1,"catid":"10","created":"2015-08-16 21:26:06","created_by":"753","created_by_alias":"","modified":"2015-08-18 13:46:18","modified_by":"753","checked_out":"753","checked_out_time":"2015-08-18 13:45:56","publish_up":"2015-08-16 21:26:06","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":2,"ordering":"1","metakey":"","metadesc":"","access":"1","hits":"0","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0);
INSERT INTO `j_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
(16, 7, 1, '', '2015-08-18 13:46:45', 753, 3659, 'ec750393a36005891793d05f31f9b73ee51659df', '{"id":7,"asset_id":"63","title":"Google Maps can now tell you if it\\u2019s worth installing solar panels on your roof","alias":"google-maps-can-now-tell-you-if-it-s-worth-installing-solar-panels-on-your-roof","introtext":"<p>Google wants to help you harness the power of the sun. A new service called Project Sunroof aims to provide a \\"treasure map\\" of solar energy with the help of Google Maps. Sunroof gives homeowners detailed information about how much solar power their roof can generate and how much money they could save on electricity costs by adding solar panels.<\\/p>\\r\\n<p>Sunroof uses data from Google Maps that previously had no practical application. For instance, Sunroof uses Maps\\u2019 3D-modeling to calculate the amount of space a building\\u2019s roof has for solar panels. The service also analyzes the positioning of the sun over the course of a year, as well as the type of cloud cover and temperature the neighborhood usually experiences. It even considers the amount of shade cast by nearby objects.<\\/p>\\r\\n<p>Switching to solar energy can be a win-win scenario for many households. Harnessing a free power source can help save money on the electric bill while ever-so-slightly decreasing the world''s dependance on greenhouse-gas-producing fossil fuels. But it''s possible your home doesn''t get enough sunlight, and it can be hard to know exactly how much money you''ll save. Sunroof can tell users how many hours of usable sunlight they''ll get a year, as well as how much available space they have for solar panels on their roof.<\\/p>\\r\\n<p>If a family decides those cost-saving benefits are good enough, Sunroof will suggest installers nearby who can load the panels. Installing solar panels isn''t cheap, costing upwards of $20,000, but the average homeowner can save about $20,000 by switching to solar energy \\u2014 if their home is in the right spot.<\\/p>\\r\\n<p>Right now, Project Sunroof is only available for people living in Boston, San Francisco, and Fresno, but Google plans to expand the service to the entire country.<\\/p>","fulltext":"","state":1,"catid":"9","created":"2015-08-15 21:25:05","created_by":"753","created_by_alias":"","modified":"2015-08-18 13:46:45","modified_by":"753","checked_out":"753","checked_out_time":"2015-08-18 13:46:35","publish_up":"2015-08-15 21:25:05","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":2,"ordering":"1","metakey":"","metadesc":"","access":"1","hits":"0","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(17, 6, 1, '', '2015-08-18 13:46:51', 753, 3533, 'f024a2fc57990b7e0acbb59d0d3f38aeb68919d2', '{"id":6,"asset_id":"62","title":"US gives Shell the final approval it needs to drill for oil in the Arctic","alias":"us-gives-shell-the-final-approval-it-needs-to-drill-for-oil-in-the-arctic","introtext":"<p>The US government has given Royal Dutch Shell the final approval it needs to drill for oil below the Arctic Ocean floor, off Alaska''s northwest coast. Shell plans to drill two exploration wells before late September, when the open-water season ends.<\\/p>\\r\\n<p>US officials approved the permit after Shell bought technology that should help avoid well blowouts. Shell had previously only been allowed to drill the top sections of the two wells located in the Chukchi Sea because an important piece of equipment \\u2014 called the \\"capping stack\\" \\u2014 needed to be repaired in Portland, Oregon, reports the Associated Press. Now that the icebreaker carrying the equipment has made it to Alaska, Shell is free to drill at about 8,000 feet below the ocean floor for the first time in over 20 years.<\\/p>\\r\\n<p>\\"We will continue to monitor their work around the clock to ensure the utmost safety and environmental stewardship,\\" Brian Salerno, Director of the US Bureau of Safety and Environmental Enforcement, said in a statement.<\\/p>\\r\\n<p>The oil giant has faced a lot of opposition from environmental activists over its activities in the Arctic. Last month, Greenpeace activists tried to stop Shell''s vessel from leaving Portland by dangling themselves from a bridge, blocking the icebreaker''s path. They managed to stall the vessel for a while, but the ship made it through after law-enforcement officials removed three of the 13 activists dangling from the bridge.<\\/p>\\r\\n<p>Shell has already spent over $7 billion on exploration in the Chukchi Sea and in the Beaufort Sea, off Alaska''s north coast. The US Arctic waters contain about 26 billion barrels of recoverable oil, according to the US Geological Survey.<\\/p>","fulltext":"","state":1,"catid":"9","created":"2015-08-16 21:24:16","created_by":"753","created_by_alias":"","modified":"2015-08-18 13:46:51","modified_by":"753","checked_out":"753","checked_out_time":"2015-08-18 13:46:36","publish_up":"2015-08-16 21:24:16","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":2,"ordering":"2","metakey":"","metadesc":"","access":"1","hits":"0","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(18, 4, 1, '', '2015-08-18 13:47:40', 753, 3647, 'ab261009ad999c43748b760aea71611c9ea51b94', '{"id":4,"asset_id":"60","title":"The BMW Concept M4 GTS is an M4 on steroids \\u2014 and you''ll be able to buy it","alias":"the-bmw-concept-m4-gts-is-an-m4-on-steroids-and-you-ll-be-able-to-buy-it","introtext":"<p>BMW has a reputation of releasing uprated M3s over the years, going all the way back to the legendary E30 of the \\u201980s and early \\u201990s. With some rare, watered-down exceptions, though \\u2014 the E46 ZCP and E92 Lime Rock Park Edition, for instance \\u2014 they haven''t made it to the US. That changes with the new M4 GTS, being shown in concept form at Pebble Beach this week.<\\/p>\\r\\n<p>Like the last-generation M3 GTS, the Concept M4 GTS is focused on shaving weight and boosting power to help transform the car from a road machine into a road-track hybrid. It looks like BMW isn''t talking exact numbers yet, but the GTS will get a boost over the standard M4''s 425 horsepower thanks to water injection, which sprays a fine mist into the engine''s intake manifold. That keeps it cooler, which allows the turbocharger to operate at higher boost without compromising reliability. (M3 engines have generally been reliable over the years, apart from a nasty issue early in the E46''s run that eventually got fixed.)<\\/p>\\r\\n<p>Other performance-oriented changes on the GTS include a hood made of carbon fiber reinforced plastic (CFRP) \\u2014 the same strong, ultra-lightweight material used extensively on the i3 and i8 \\u2014 instead of aluminum, and a manually adjustable splitter and wing. (And, goodness, what a wing it is.)<\\/p>\\r\\n<p>The car is painted in a menacing, matte dark gray trimmed with orange, just to make sure everyone on the road realizes you''re not driving a workaday M4. In back, the concept is fitted with the OLED taillights that BMW has been touting lately, though it''s not clear whether they''ll make it to the production model.<\\/p>\\r\\n<p>There''s no word yet on exactly when this is going on sale, but it''ll be a limited-production affair \\u2014 so be ready to get your deposit in very, very quickly.<\\/p>","fulltext":"","state":1,"catid":"10","created":"2015-08-15 21:23:06","created_by":"753","created_by_alias":"","modified":"2015-08-18 13:47:40","modified_by":"753","checked_out":"753","checked_out_time":"2015-08-18 13:46:59","publish_up":"2015-08-15 21:23:06","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":2,"ordering":"2","metakey":"","metadesc":"","access":"1","hits":"0","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(19, 3, 1, '', '2015-08-18 13:47:49', 753, 2909, 'fd267ff5c62f94b3ab2e0b7c65ca7689e3cf1500', '{"id":3,"asset_id":"59","title":"Google delays its Project Ara modular smartphone until 2016","alias":"google-delays-its-project-ara-modular-smartphone-until-2016","introtext":"<p>Google is pushing back plans to release its deeply customizable Project Ara smartphone hardware until sometime in 2016. The Ara team today tweeted a message acknowledging the delay and shift away from plans to test out the modular phone project in Puerto Rico later this year. But Google was also quick to note that it''s in the process of scouting \\"a few locations in the US\\" for Ara. Google''s explanation for the change suggests that the team has been hard at work to make Ara a reality. \\"Lots of iterations... more than we thought,\\" the company tweeted.<\\/p>\\r\\n<p>\\u00a0<\\/p>\\r\\n<p>Project Ara allows users to swap out and upgrade the core components of a smartphone (processor, camera, etc.) individually rather than replace the whole device. It represents a dramatic rethinking of the mobile phone, and attendees at Google I\\/O were thrilled when the company showed a working prototype on stage in May. The progression to a consumer product seems to be taking a bit longer than anticipated, however. Google had originally aimed to have between 20 and 30 Ara modules available for the now-scrapped Puerto Rico pilot.<\\/p>","fulltext":"","state":1,"catid":"8","created":"2015-08-16 21:22:19","created_by":"753","created_by_alias":"","modified":"2015-08-18 13:47:49","modified_by":"753","checked_out":"753","checked_out_time":"2015-08-18 13:47:02","publish_up":"2015-08-16 21:22:19","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":2,"ordering":"1","metakey":"","metadesc":"","access":"1","hits":"0","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0),
(20, 1, 1, '', '2015-08-18 13:48:19', 753, 5436, '583b8ba3e01c890abd3ab39bba5f8e27afcfccfc', '{"id":1,"asset_id":"57","title":"Windows 10 is the end of cloud-free computing","alias":"windows-10-is-the-end-of-cloud-free-computing","introtext":"<p>In the weeks after its release, Windows 10 users have noticed something strange \\u2014 it''s always phoning home. Last week, an Ars Technica investigation found Windows computers sending data back to Microsoft servers even after services like Cortana and OneDrive had been disabled, in one case even sending back a message as soon as users hit the Start button.<\\/p>\\r\\n<p>It''s a telling change for Microsoft \\u2014 the last major tech company built on self-contained software \\u2014 and it\\u2019s set off a string of related worries. If any Microsoft users had been scared off by data collection from Google and Apple, they now have nowhere to turn. Reached by Ars Technica, the company was quick to defend itself, saying, \\"No query or search usage data is sent to Microsoft, in accordance with the customer''s chosen privacy settings.\\" Most of the data is anonymized usage logging, not inherently a privacy concern, but the fact remains: using Windows 10 requires constant access to Microsoft''s remote servers, and that access goes both ways.<\\/p>\\r\\n<p>In 2015, this is simply how computing works. Consumers expect smart recommendations and continually improving services. We expect computers \\u2014 all computers \\u2014 to be able to answer any question at any time. In return, companies get constant access to your computer for data collection, automatic updates, and offboard processing. This isn''t an option anymore; it''s the default. And anyone who doesn''t like the deal is going to have a very hard time using today''s computers.<\\/p>\\r\\n<p>Mobile tech works this way out of necessity \\u2014 there simply isn''t the processing power to take on more complex tasks \\u2014 and over the last five years, even more powerful computers have followed that model. It''s essentially the premise of all Google''s software efforts. Most Chromebooks are constantly feeding data back to Google servers, even though it happens more often through Drive or Search services than the OS itself. If the services are going to improve, engineers need to know what''s working and what isn''t \\u2014 and since the services themselves are all free, some level of data-targeted advertising is inevitable. Companies go back and forth on how much to collect and how much to anonymize, but the overall choices have turned out very much the same. Apple ran into its own version of this problem when Yosemite launched last year: the revamped Spotlight Search function fed queries back to Apple Headquarters. But if Spotlight is going to handle web-facing queries like \\"restaurants near me,\\" what else could it do?<\\/p>\\r\\n<p>For a long time, Microsoft was the exception to this rule. The company has rolled out lots of cloud services, but they''ve been discrete offerings, rarely baked into the OS itself, in part because the new approach cut against Microsoft''s traditional strengths. That logic changed with Windows 10 because it had to. If Microsoft is going to steal users back from Apple and Google, it needs to match services like Siri and Google Voice, which means plugging into the cloud at the deepest possible level.<\\/p>\\r\\n<p>But while software has changed, the world has been changing around it. Corporate clouds aren''t as secure as they once were, and we''ve seen them compromised by government spies and Redditors alike. Last year, Microsoft chased down an in-house leaker by peeking into a private blogger''s Hotmail account, offering profuse apologies after the fact. But for anyone who wants to exercise stronger control over their own email, their own hardware, their own data, it''s hard to know where to turn. Leaving your computer in a company''s hands is quite literally the only option.<\\/p>","fulltext":"","state":1,"catid":"8","created":"2015-08-18 21:20:19","created_by":"753","created_by_alias":"","modified":"2015-08-18 13:48:19","modified_by":"753","checked_out":"753","checked_out_time":"2015-08-18 13:48:09","publish_up":"2015-08-18 21:20:19","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":2,"ordering":"2","metakey":"","metadesc":"","access":"1","hits":"0","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0);
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='Available Updates';
...
(1, 3, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.3.3.15', '', 'http://update.joomla.org/language/details3/uk-UA_details.xml', '', ''),
(2, 3, 0, 'Uyghur', '', 'pkg_ug-CN', 'package', '', 0, '3.3.0.1', '', 'http://update.joomla.org/language/details3/ug-CN_details.xml', '', ''),
(3, 3, 0, 'Albanian', '', 'pkg_sq-AL', 'package', '', 0, '3.1.1.1', '', 'http://update.joomla.org/language/details3/sq-AL_details.xml', '', ''),
(4, 3, 0, 'Hindi', '', 'pkg_hi-IN', 'package', '', 0, '3.3.6.1', '', 'http://update.joomla.org/language/details3/hi-IN_details.xml', '', ''),
(5, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.4.3.1', '', 'http://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(6, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
(7, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.4.3.1', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
(8, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(9, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
(10, 3, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '3.2.1.1', '', 'http://update.joomla.org/language/details3/vi-VN_details.xml', '', ''),
(11, 3, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.3.0.2', '', 'http://update.joomla.org/language/details3/id-ID_details.xml', '', ''),
(12, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', '', ''),
(13, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.4.3.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
(14, 3, 0, 'Montenegrin', '', 'pkg_srp-ME', 'package', '', 0, '3.3.1.1', '', 'http://update.joomla.org/language/details3/srp-ME_details.xml', '', ''),
(15, 3, 0, 'EnglishCA', '', 'pkg_en-CA', 'package', '', 0, '3.3.6.1', '', 'http://update.joomla.org/language/details3/en-CA_details.xml', '', ''),
(16, 3, 0, 'FrenchCA', '', 'pkg_fr-CA', 'package', '', 0, '3.4.3.1', '', 'http://update.joomla.org/language/details3/fr-CA_details.xml', '', ''),
(17, 3, 0, 'Welsh', '', 'pkg_cy-GB', 'package', '', 0, '3.3.0.2', '', 'http://update.joomla.org/language/details3/cy-GB_details.xml', '', ''),
(18, 3, 0, 'Sinhala', '', 'pkg_si-LK', 'package', '', 0, '3.3.1.1', '', 'http://update.joomla.org/language/details3/si-LK_details.xml', '', ''),
(19, 3, 0, 'Dari Persian', '', 'pkg_prs-AF', 'package', '', 0, '3.4.3.1', '', 'http://update.joomla.org/language/details3/prs-AF_details.xml', '', '');
...
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1439905454, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1439905454, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1439905452, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'http://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1439905452, '');
...
(753, 'Super User', 'adrielcafe', 'ac@adrielcafe.com', '$2y$10$g2Fcqu5wvEfXWpWcGBwyUu60d0P14n3e9EpRe7sZjgUyVz1tV/SNq', 0, 1, '2015-08-17 21:06:02', '2015-08-18 13:44:11', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);
...
INSERT INTO `j_user_keys` (`id`, `user_id`, `token`, `series`, `invalid`, `time`, `uastring`) VALUES
(1, 'adrielcafe', '$2y$10$DIXCvPJrA0d.3ikpJE2K5urUmu5HwkRuonTTDf4c2A9waqaXbAFDW', 'RnSDosUtP5ycBYvv66XE', 0, '1445084560', 'cd625af3296ce0bb972073a56314c436');
